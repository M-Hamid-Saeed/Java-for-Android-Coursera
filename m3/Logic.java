...
public class Logic
    ...
    public static double rightTrianglePerimeter(double base, double height){
        ...
        double squarroot=Math.sqrt(baseSquare+heightSquare);
        return base+height+squarroot;
    }
    ...
    public static double boxSurfaceArea(double length, double width,double depth){
        //Every side area is calculated indivdiually
        double upperSideArea=2*length*width;
        double rightSideArea=2*length*depth;
        double downSideArea=2*width*depth;
        //returning all sides area
        return upperSideArea+rightSideArea+downSideArea;
    }
